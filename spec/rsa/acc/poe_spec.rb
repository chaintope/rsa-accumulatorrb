...
RSpec.describe RSA::ACC::PoE do
  ...
  describe 'proof for small exp' do
    it 'should be proven.' do
      ...
      proof = RSA::ACC::PoE.prove(base, exp, result, RSA::Accumulator::RSA3072_MODULUS)
      expect(RSA::ACC::PoE.verify(base, exp, result, proof, RSA::Accumulator::RSA3072_MODULUS)).to be true
